...
x_obs.to_csv('data/transship_la_input.csv', index=False)
...
# save model
bst.save_model('data/transship_la.model')


#______________________________________
# predict
bst = xgb.Booster()
bst.load_model('data/transship_la.model')
...
xy.to_csv('data/transship_la.csv')
...
foo.to_csv('data/transship_binned1_la.csv', index=False)


#________________________________________________
# prediction error
foo = obs.copy()
x_obs = pd.read_csv('data/transship_la_input.csv')
bst = xgb.Booster()
bst.load_model('data/transship_la.model')
x = xgb.DMatrix(x_obs)
...
foo.to_csv('data/transship_binned1_la_pred.csv', index=False)
...
#save
np.save('data/transship_la_shap.npy', shap_value)


#________________________________
# feature importance

shap_value = np.load('data/transship_la_shap.npy')
x_obs = pd.read_csv('data/transship_la_input.csv')
...
# save
importance.to_csv('data/transship_la_importance.csv')
...
effect.to_csv('data/transship_la_effect.csv')
