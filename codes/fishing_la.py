...
# trips with la flag, gear, time at sea
all = data.copy()
del data
...
x_obs.to_csv('data/fishing_la_input.csv', index=False)
...
# save model
bst.save_model('data/fishing_la.model')


#________________________________________
# prediction error
x_obs = pd.read_csv('data/fishing_la_input.csv')
x = xgb.DMatrix(x_obs)
bst = xgb.Booster()
bst.load_model('data/fishing_la.model')
...
foo.to_csv('data/fishing_la_pred.csv', index=False)
...
foo.to_csv('data/fishing_la_obs.csv', index=False)
...
bar.to_csv('data/fishing_la.csv', index=False)
...
#save
np.save('data/fishing_la_shap.npy', shap_value)
...
shap_value = np.load('data/fishing_la_shap.npy')
x_obs = pd.read_csv('data/fishing_la_input.csv')
...
# save
importance.to_csv('data/fishing_la_importance.csv')
...
effect.to_csv('data/fishing_la_effect.csv')
